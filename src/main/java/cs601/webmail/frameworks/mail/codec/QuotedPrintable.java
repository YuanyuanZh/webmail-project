...
public class QuotedPrintable extends MimeCodec {
    ...
    static {
        MimeCodec.register("quoted-printable", QuotedPrintable.class);
    }
     ...
     */
    @Override
    public String decode(byte[] qp, String enc) {
        int len=decode(qp);
        try {
     ...
     */
    @Override
    public String encode(String content, String enc) {
        if (content == null)
            return null;
    ...
    private void checkLineLength(int required, StringBuilder out) {
